<x-app-layout>
    ...
    <div id="waktuModal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full inset-0 h-[calc(100%-1rem)] max-h-full bg-black/40">
        <div class="relative p-4 w-full max-w-lg max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                <div class="flex items-center justify-between p-4 border-b rounded-t">
                    <h3 class="text-lg font-semibold text-gray-900">Pilih Waktu Booking</h3>
                    <button type="button"
                ...
                <div class="p-4 space-y-3">
                    <div class="grid grid-cols-3 gap-2">
                        @foreach ($times as $i => $time)
                            <button type="button"
                                class="time-btn border text-gray-700 border-gray-300 rounded-md py-2 text-sm hover:bg-green-600 hover:text-white transition"
                                data-time="{{ $time }}">
                                {{ $time }}
                            </button>
                        @endforeach
                ...
                <div class="flex justify-end p-4 border-t">
                    <button type="button" data-modal-hide="waktuModal"
                        class="text-gray-600 bg-gray-100 hover:bg-gray-200 font-medium rounded-md text-sm px-4 py-2">
                        Tutup
                    </button>
                </div>
            </div>
